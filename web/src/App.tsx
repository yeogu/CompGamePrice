...
type AdminSection = 'dashboard' | 'steam' | 'epic-games' | 'ubisoft-store' | 'gog' | 'nintendo-eshop' | 'playstation-store' | 'microsoft-store' | 'google-play' | 'apple-app-store' | 'integrity' | 'audit'
