...
type AdminSection = 'dashboard' | 'steam' | 'epic-games' | 'ubisoft-store' | 'gog' | 'meta-quest-store' | 'ea-app' | 'battle-net' | 'nintendo-eshop' | 'playstation-store' | 'microsoft-store' | 'google-play' | 'apple-app-store' | 'integrity' | 'audit'
  ...
  return (
    <div className="app-shell">
      ...
      {activeView === 'admin' && catalogAdminEnabled && user?.role === 'ADMIN' && <section className="view-panel" ref={adminPanelRef}>
        ...
        {adminStore !== 'Epic Games Store' && adminStore !== 'Meta Quest Store' && adminStore !== 'EA app' && adminStore !== 'Battle.net' && adminStore !== 'PlayStation Store' && adminStore !== 'Microsoft Store' && <div className="admin-search">
