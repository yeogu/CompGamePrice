...
APPLE_MAC_GAMES_GENRE_ID = "12006"
APPLE_GAMES_GENRE_IDS = {APPLE_GAMES_GENRE_ID, APPLE_MAC_GAMES_GENRE_ID}
...
def is_game(product: dict) -> bool:
    ...
    return (
        primary_genre_id in APPLE_GAMES_GENRE_IDS
        or bool(APPLE_GAMES_GENRE_IDS & genre_ids)
