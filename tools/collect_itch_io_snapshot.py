#!/usr/bin/env python3
"""Collect registered itch.io minimum prices from official game pages."""
...
def main() -> int:
    ...
    parser.add_argument("--output", default=root / "snapshots/latest/itch_io_products.txt", type=Path)
    args = parser.parse_args()
    collected, failures = collect(args.catalog, args.output)
    print(f"Collected {collected} itch.io products")
